...
from knowledge.loader import preprocess_jf_content, extract_bids_from_sequence
import json
...
for i, segment in enumerate(segments, 1):
    ...
    if '1NT开叫' in ' '.join(keywords) or '1NT开叫后的' in content:
        ...
        test_sequences = [
            "(南)1NT-(西)pass-(北)2C-(东)pass-",
            "(南)1NT-(西)pass-(北)2D-(东)pass-",
            "(南)1NT-(西)pass-(北)2H-(东)pass-",
            "(南)1NT-(西)pass-(北)2S-(东)pass-",
            "(南)1NT-(西)pass-(北)2NT-(东)pass-",
            "(南)1NT-(西)pass-(北)3C-(东)pass-",
        ]

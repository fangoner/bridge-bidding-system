...
content = segments[44]['content']

print("=" * 80)
print("测试片段44：第三四家开叫1S")
print("=" * 80)
...
test_cases = [
    ...
    "(南)1S-(西)pass-(北)2C-(东)pass-",
    "(南)1S-(西)pass-(北)2C-(东)pass-(南)2D-(西)pass-",
    "(南)1S-(西)pass-(北)2C-(东)pass-(南)2H-(西)pass-",
    "(南)1S-(西)pass-(北)2S-(东)pass-",
]

...
test_cases = [
    "(南)2D-(西)pass-(北)2NT-(东)pass-(南)3C-(西)pass-",
    "(南)2D-(西)pass-(北)2NT-(东)pass-(南)3C-(西)pass-(北)3D-(东)pass-",
    "(南)2D-(西)pass-(北)2NT-(东)pass-(南)3D-(西)pass-",
    "(南)2D-(西)pass-(北)2NT-(东)pass-(南)3H-(西)pass-",
    "(南)2D-(西)pass-(北)2NT-(东)pass-(南)3S-(西)pass-",
]

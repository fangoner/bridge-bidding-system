...
CASES = [
    ...
    # ── 对侧单张排除（2026-09-24 用户定调）：对侧该花色仅 1 张，引牌后机械
    #    跟出、无飞张选择 → 对侧牌不作飞张候选；引牌本身作飞张仍保留 ──
    ("对侧单张 伙伴引3(排除)",  "J",   "32", "A", "♦3", "伙伴侧", False),
    ("对侧单张 伙伴引2(排除)",  "J",   "32", "A", "♦2", "伙伴侧", False),
    ("对侧双张 伙伴引3(保留)",  "KJ",  "32", "A", "♦3", "伙伴侧", True),
    ("对侧单张 本侧引K(保留)",  "K2",  "Q",  "A", "♦K", "本侧", True),
]

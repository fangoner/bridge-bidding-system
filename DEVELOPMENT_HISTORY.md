...
> ⚠️ **本文件是历史档案（归档快照），不是现状文档** — 2026-09-20 标注。
> 其中文句如"**（当前版本）**"是**归档当时**的标注（例：`### v1.48 (当前版本)`），**不代表今天的版本**——当前版本请见 `CHANGELOG.md` 与 `DEVELOPMENT.md`；现状架构见 `CLAUDE.md`。
> 本文件内容一律按归档时点理解，不做同步维护。审计与治理记录见 `docs/开发文档整理_发现清单_20260920.md`。
